    ...
    ?>
        ...
        <div class="row mb-4">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card mb-4">
                    <div class="card-body flexbox-b">
                        <div class="easypie mr-4" data-percent="<?=$pieNoasig?>" data-bar-color="#f39c12" data-size="80"
                            data-line-width="8">
                                ...
                                <div class="media-body d-flex">
                                    <div class="flex-1">
                                        <h5 class="media-heading">
                                            <a
                                                href="<?=base_url()?>index.php?/ticket/seguimiento/<?=$pendiente->folio?>">#<?=$pendiente->folio?>:
