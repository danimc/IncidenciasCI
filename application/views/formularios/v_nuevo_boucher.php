...
<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
 ...
 <div class="page-heading">
                <h1 class="page-title">Registrar Nuevo Boucher:</h1>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="index-2.html"><i class="la la-home font-20"></i></a>
                    </li>
                    <li class="breadcrumb-item">UPPI</li>
                    <li class="breadcrumb-item">Nuevo Boucher</li>
                </ol>
                <br>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="ibox ibox-fullheight">
                <div class="ibox-head">
                    <div class="ibox-title">Datos del Registro</div>
                </div>
                <div class="ibox-body">
                    <div class="row">
                        <div class="form-group mb-6 col-md-12 ">
                            <label class="col-sm-12 col-form-label">ISBN: </label>
                            <div class="col-sm-12">
                               <input type="text" name="isbn" id="isbn" class="form-control-sm col-md-7">
                            </div>
                        </div>
                         <div class="form-group mb-6 col-md-12 ">
                            <label class="col-sm-12 col-form-label">DEPENDENCIA QUE SOLICITA: </label>
                            <div class="col-sm-12">
                               <input type="text" name="dependencia" id="dependencia" class="form-control-sm col-md-12">
                            </div>
                        </div>
                        <div class="form-group mb-6 col-md-6 ">
                            <label class="col-sm-12 col-form-label">EXPEDIENTE INTERNO: </label>
                            <div class="col-sm-12">
                               <input type="text" name="expediente" id="expediente" class="form-control-sm col-md-12">
                            </div>
                        </div>
                        <div class="form-group mb-6 col-md-6 ">
                            <label class="col-sm-12 col-form-label">FECHA DE CONSTANCIA: </label>
                            <div class="col-sm-12">
                               <input type="date" name="fecha" id="fecha" class="form-control-sm col-md-12">
                            </div>
                        </div>    
          ...
          <!--  <div class="col-md-10">
                <div class="ibox ibox-fullheight">
                    ...
                    <div class="ibox-footer">
                        ...
                        <a class="btn btn-danger" href="javascript: history.go(-1)">Salir</a>
                    </div>  
